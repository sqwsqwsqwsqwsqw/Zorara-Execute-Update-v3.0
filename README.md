...
[![Stars](https://img.shields.io/github/stars/Zorara-Execute-Update-v3.0?style=flat-square)](https://github.com)
...
git clone https://github.com/Zorara-Execute-Update-v3.0.git
cd Zorara-Execute-Update-v3.0
